...
plot_summary:
  time: '夏日的深夜'
  location: '营地'
  scene: '黛琳讲Artifact.Transformable'
  season: '夏季'
  environment: '夜空清澈，星星闪烁，帐篷里夜灯柔和，蝉鸣渐弱，露水悄悄凝结在草叶上'
  topic: 'Artifact.Transformable可变形的构建魔法'
  discussion: '什么是可变形Artifact，如何在构建过程中转换artifact'
  problem_solved: '理解Artifact.Transformable的作用，掌握artifact转换的方法'
volume_grade: 'B'
