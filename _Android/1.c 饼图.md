...
![](../assets/blogimages/../assets/blogimages/Pasted image 20240125004426.png)
...
![](../assets/blogimages/../assets/blogimages/Pasted image 20240125010104.png)

 总结

饼图 和 [[1.b 仪表盘绘制]]  的计算方式有相似之处，即都是利用三角函数正余弦来计算偏移的x，y值。

![](../assets/blogimages/../assets/blogimages/Pasted image 20240125011432.png)
